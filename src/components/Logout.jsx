...
function Logout() {
  ...
  return (
    <div className="flex">
      <Link
        to="/dashboard"
        className="flex items-center gap-2.5 mx-2 border border-gray-500/30 px-4 py-2 text-sm text-gray-800 rounded bg-white hover:text-cyan-500 hover:bg-cyan-500/10 hover:border-cyan-500/30 active:scale-95 transition"
      >
        <svg
          width="18"
          height="18"
      ...
      <button
        className="px-3 py-2 bg-red-500 text-white rounded-md cursor-pointer hidden md:block"
